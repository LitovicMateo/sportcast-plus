  ...
  return (
    <div className="w-full h-[500px] 2xl:w-[662px] xl:w-[500px] md:w-[400px] flex flex-col px-4 md:px-0 gap-[12px] md:gap-6 lg:h-[680px]">
      <div className="w-full max-w-full h-[260px] lg:h-[378px] relative overflow-clip">
        <Image className="hover:scale-110 transition-all ease-linear" src={post.featuredImage.node.sourceUrl} fill alt={post.slug} objectFit="cover" />
      </div>
      <div className="w-[676px] max-w-full overflow-clip ">
        <div className="min-h-[60px] flex flex-col justify-end">
          <h2 className={`text-wrap text-[#FFFFFF] p-0 pb-[12px] text-[18px] md:text-[24px] border-b-1 border-solid border-[#67676781] ${merriweather.className}`}>{post.title}</h2>
          {/* <BreakLine /> */}
        </div>
